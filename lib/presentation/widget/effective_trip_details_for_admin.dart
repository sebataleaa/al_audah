...
import 'package:al_audah/presentation/screens/admin/view_truck_for_admin.dart';
...
class EffectiveTripDetailsForAdmin extends StatelessWidget{
            ...
            children: [
              ...
              Expanded(
                child: GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder:(context)=>ViewTruckForAdmin()));
                  },
                  child: Container(
                    height: 40.h,
                    color: AppColors.mediumBlue,
