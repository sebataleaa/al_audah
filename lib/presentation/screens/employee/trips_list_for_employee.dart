...
import 'package:al_audah/presentation/screens/employee/effective_trips_for_employee.dart';
import 'package:al_audah/presentation/widget/trips_list_text.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

import 'archived_trips_for_employee.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            EffectiveTripsForEmployee(),
            ArchivedTripsForEmployee(),
          ],
        ),
      ),
    );
